...
index.html
25KB
Markup, styles, script tags
app-core.js
73KB
Data loading, team ratings, FDR, prediction model
app-squad.js
53KB
Signals, squad, transfers, chips, news, dashboard
app-render.js
55KB
Player card, pitch, list, tables, page markup
app-odds.js
58KB
Bookmaker odds
app-main.js
...
.tallscroll container (max-height:calc(100vh - 168px)) with position:stickythead th; Signals column moved after Price and widened to fit 5 icons on one row
